...
public class Program16Point {
    ...
    // distance method without parameter with double return type -- to calculate distance between two points
    public double distance()
    {
        return Math.sqrt((x*x)+(y*y));
    }
    // distance method with two parameter with double return type--to calculate distance between two points
    ...
    // * Method named distance with parameter another of type Point, it needs to return the distance
    //between this Point and another Point as double.
    public double distance(Program16Point point2)
    {
    return Math.sqrt((point2.getX()-this.getX())* (point2.getX()-this.getX()) + (point2.getY()-this.getY()) * (point2.getY()-this.getY()));
    }
