...
public static boolean hasShareDigit( int firstNumber,int seconNumber)
        {
            if ((firstNumber>=10 && firstNumber<=99) && (seconNumber >= 10 && seconNumber <=99)){
            int firstNumberLastDigit = firstNumber % 10;
            int secondNumberLastDigit = seconNumber % 10;

            firstNumber /=10;
            seconNumber /=10;
            int firstNumberFirstDigit = firstNumber;
            int secondNumberFirstDigit = seconNumber;
